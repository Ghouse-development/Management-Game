...
// 正確な期別戦略目標（v10シミュレーション結果反映 - 2026-01-04 v3）
//
// 【最新10,000回シミュレーション結果】
// 1位: 積極投資型（3期大型化+セールスマン2名）= 84%達成率, 92%勝率 ★★最適★★
// 2位: プレイヤー（チップなし）= 0%達成率, 6%勝率
// 3位: 研究開発型 = 0%達成率, 2%勝率
// 4位: バランス型 = 0%達成率, 1%勝率
//
// 【重要な発見】
// - 2期は長期借入禁止のため、大型機械購入は資金不足リスクあり
// - 3期に借入→小型売却→大型購入→セールスマン2名が最強
// - 最良ケース: 総売上¥2,162、自己資本¥880達成
// - チップは研究1枚で十分、過度な投資は逆効果
//
// 【以下は2期大型化戦略（参考）】
// - 2期大型化のみ: 4%達成, 66%勝率
// - 2期大型化+採用1名: 57%達成, 90%勝率
